...
@WebAppConfiguration
@ContextConfiguration(classes= { org.zerock.config.RootConfig.class, org.zerock.config.ServleConfig.class } )
@Log4j
public class BoardControllerTests {
    ...
    public void testRemove() throws Exception{
    	...
    	String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "44")).andReturn().getModelAndView().getViewName();
